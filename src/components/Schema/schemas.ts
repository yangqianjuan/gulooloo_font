...
export const createOrganizationSchema = (locale: string = 'en'): JsonLdSchema => ({
  ...
  description: "Gulooloo Tech develops practical and wellness apps that help everyday people boost productivity and wellness.",
  foundingDate: "2020",
...
export const createAppSchema = (appId: string, locale: string = 'en'): JsonLdSchema => {
  const appData = {
    'easynotes': {
      name: "Easy Notes",
      description: "Capture ideal, organize thoughts, and track tasks effortlessly.",
      ...
      downloadUrls: [
        "https://apps.apple.com/app/easy-notes/id1234567890",
        "https://play.google.com/store/apps/details?id=com.gulooloo.easynotes"
      ]
    },
    'invoicemaker': {
      name: "Invoice Maker",
      description: "Make invoices and estimates easily with a wide selection of beautiful templates.",
      ...
      downloadUrls: [
        "https://apps.apple.com/app/invoice-maker/id1234567891",
        "https://play.google.com/store/apps/details?id=com.gulooloo.invoicemaker"
      ]
    },
    'gofasting': {
      name: "GoFasting",
      description: "Tailor fasting plans for you, and provide step-by-step guidance.",
      ...
      downloadUrls: [
        "https://apps.apple.com/app/gofasting/id1234567892",
        "https://play.google.com/store/apps/details?id=com.gulooloo.gofasting"
      ]
    },
    'QRgenerator': {
      ...
      downloadUrls: [
        "https://apps.apple.com/app/qr-generator/id1234567893",
        "https://play.google.com/store/apps/details?id=com.gulooloo.qrgenerator"
      ]
    }
  };
